...
/**
 * Для хранения таблиц с группировками по определенным свойствам
 * Этот класс сделан для того чтобы небыло большой вложенности в разных местах,
 * а так мы храним все в одной таблице
 * и имеем быстрый доступ к отдельно сгруппированным группам
 */
class Table {
    /**
